...
- (void)viewDidLoad {
    ...
    [self createNavWithLeftBtnImageName:@"返回" leftHighlightImageName:nil leftBtnSelector:@selector(back) andCenterTitle:@"关于康庄"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (_isIntroduceCell) {
        ...
        cell.phoneClickedHandle = ^(NSString *phoneNum) {
