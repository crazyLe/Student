...
@interface  MyOderExtraBottomCell()<UITextViewDelegate>

@end

@implementation MyOderExtraBottomCell
...
- (void)createUI
{
    UILabel * firstLabel = [[UILabel alloc]initWithFrame:CGRectMake(30, hSpacingNum, 40, 15)];
    firstLabel.text = @"赚豆:";
    ...
    _secondTextView = [[UITextField alloc]initWithFrame:CGRectMake(26+36+4, hSpacingNum-9, 122, 34)];
...
//    _secondTextView.attributedText = [self getAttrStringWithZhuanDouNum:@"1000"];
    ...
    UILabel * thirdLabel = [[UILabel alloc]initWithFrame:CGRectMake(26+36+122+5+4, hSpacingNum, 120, 14)];
    ...
    UILabel * fourthLabel = [[UILabel alloc]initWithFrame:CGRectMake(26+36+4, CGRectGetMaxY(_secondTextView.frame)+8, 230, 15)];
    ...
    _payFirstBtn.frame = CGRectMake(26+36+4, CGRectGetMaxY(fourthLabel.frame)+18, 102, 31);
    ...
    _paySecondBtn.frame = CGRectMake(26+36+102+4, CGRectGetMaxY(fourthLabel.frame)+18, 102, 31);
    ...
    //    _warningLabel.backgroundColor = [UIColor greenColor];
