...
@interface KZADLunchView()

@property (nonatomic, strong) UIView *parentView;    // The parent view this 'dialog' is attached to
@end

@implementation KZADLunchView
@synthesize parentView, containerView, dialogView;
@synthesize closeOnTouchUpOutside, showXCloseButton, hasGradientLayer;
...
- (id)init {
    ...
    if (self) {
        ...
        closeOnTouchUpOutside = NO;
        showXCloseButton = YES;
        hasGradientLayer = NO;
...
- (void)show
{
    ...
    // Add the close button too
    [self addXCloseButton];
...
- (void)addXCloseButton {
    if (showXCloseButton) {
        UIButton *closeButton = [UIButton buttonWithType:UIButtonTypeCustom];
        [closeButton setImage:[UIImage imageNamed:@"cycleXClose"] forState:UIControlStateNormal];
        [closeButton setFrame:CGRectMake(CGRectGetWidth(self.bounds) - 50, 80, 38, 38)];
...
- (void)touchesEnded:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event {
    ...
    if ([touch.view isKindOfClass:[KZADLunchView class]]) {
        [self close];
    }
}
