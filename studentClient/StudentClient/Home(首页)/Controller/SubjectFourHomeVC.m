...
@interface SubjectFourHomeVC ()<UITableViewDelegate,UITableViewDataSource,UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout,ItemPoolCellDelegate,SeekHelpCellDelegate> {
...
@implementation SubjectFourHomeVC
...
- (void)createNavigationBar {
    ...
    [self createCenterBtnNavWithLeftBtnImageName:@"返回" leftHighlightImageName:nil leftBtnSelector:@selector(leftBtnClick)  andCenterTitle:@"科目四" centerBtnSelector:@selector(centerBtnClick:) andRightBtnImageName:nil rightHighlightImageName:nil rightBtnSelector:nil withRightBtnTitle:nil];
...
- (CLDropDownMenu *)dropMenu {
    ...
    if (!_dropMenu) {
        ...
        _dropMenu.titleList = @[@"科目一",@"科目二",@"科目三"];
    }
