...
- (UIImageView *)bgImageView {
    ...
    if (nil == _bgImageView) {
        ...
        UIImage *image = [UIImage imageNamed:@"iconfont-study-kindbg"];
...
- (void)show {
    ...
    switch (self.direction) {
        ...
        case CLDirectionTypeBottom:
        {
            ...
            [self allVerShowWithImageName:@"iconfont-study-kindbg" initTabelViewStartFrame:tableStartFrame TabelViewEndFrame:tableEndFrame bgStartFrame:bgStartFrame bgEndFrame:bgEndFrame flag:0];
        }
